...
setuptools.setup(
    name='pollination-leed-daylight-illuminance',                                     # will be used for package name unless it is overwritten using __queenbee__ info.
    ...
    url='https://github.com/pollination/leed-daylight-illuminance',                   # will be translated to home
    project_urls={
    ...
    maintainer_email='chris@ladybug.tools, info@pollination.cloud',
